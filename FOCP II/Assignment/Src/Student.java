...
class Student{
	...
	String contactNo;
	int k ;
		Student(String firstname,String lastname,Address addr, Date dob, int monthdob, int daydob, int yeardob, String skill[],Qualification qual[],Project projects[],String eMail,String contactNo,int p, int s, int q)
		{
